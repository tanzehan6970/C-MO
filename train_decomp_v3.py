...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(train_dataset, batch_size=opt.batch_size, drop_last=True, num_workers=2,
                              shuffle=True, pin_memory=True) # origin: True
    val_loader = DataLoader(val_dataset, batch_size=opt.batch_size, drop_last=True, num_workers=2,
                            shuffle=True, pin_memory=True) # origin: True
