...
if __name__ == '__main__':
    ...
    opt.save_root = pjoin(opt.checkpoints_dir, opt.dataset_name, opt.name) # './checkpoints/t2m/length_est_bigru'
    opt.model_dir = pjoin(opt.save_root, 'model') # './checkpoints/t2m/length_est_bigru/model'
    opt.meta_dir = pjoin(opt.save_root, 'meta') # './checkpoints/t2m/length_est_bigru/meta'
    opt.log_dir = pjoin('./log', opt.dataset_name, opt.name) # './log/t2m/length_est_bigru'
    ...
    train_split_file = pjoin(opt.data_root, 'train.txt') # './dataset/HumanML3D/train.txt'
    val_split_file = pjoin(opt.data_root, 'val.txt') # './dataset/HumanML3D/val.txt'
